      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 my-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 grid-cols-1">
          {sortedBooks.map((book) => (
            <div key={book.id} className="bg-white border-3 border-gray-200 rounded-lg overflow-hidden hover:border-blue-400 transition-all duration-200 flex flex-col shadow-lg hover:shadow-xl">
              <div className="relative aspect-[2/3] bg-gray-100">
                <img
                  ...
                  alt={book.bookTitle}
                />
                <button className="absolute top-2 right-2 bg-blue-700 hover:bg-blue-800 text-white p-2 rounded-lg transition duration-200 ease-in-out transform">
